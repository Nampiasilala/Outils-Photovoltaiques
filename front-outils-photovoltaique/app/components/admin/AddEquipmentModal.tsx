// app/admin/equipments/AddEquipmentModal.tsx
"use client";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("type_equipement", e.target.value as EquipType)
                }
              ...
              <p className="text-xs text-gray-500 mt-1">
                Catégorie envoyée : {mapCategorie(form.type_equipement)}
              </p>
            </div>
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("tension_nominale_V", numOrNull(e.target.value))
                    }
                    className="border p-2 rounded w-full"
                  />
                </div>
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("puissance_surgeb_W", numOrNull(e.target.value))
                    }
                    className="border p-2 rounded w-full"
                  />
                </div>
