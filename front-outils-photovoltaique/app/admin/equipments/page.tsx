...
export default function AdminEquipmentsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-slate-900 mb-2">Équipements</h1>
      <p className="text-slate-600 mb-6">Gérez le catalogue d’équipements.</p>
      {/* TODO: table/listing des équipements */}
