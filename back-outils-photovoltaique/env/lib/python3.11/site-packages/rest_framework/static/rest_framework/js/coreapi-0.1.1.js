...
var fetchWithAuth = require('isomorphic-fetchWithAuth');
var errors = require('../errors');
var utils = require('../utils');
var URL = require('url-parse');
...
var HTTPTransport = function () {
  function HTTPTransport() {
    ...
    this.fetchWithAuth = options.fetchWithAuth || fetchWithAuth;
  ...
  _createClass(HTTPTransport, [{
    ...
    value: function action(link, decoders) {
      ...
      return this.fetchWithAuth(request.url, request.options).then(function (response) {
...
},{"../errors":11,"../utils":15,"isomorphic-fetchWithAuth":16,"url-parse":19,"url-template":21}],14:[function(require,module,exports){
'use strict';
...
// the whatwg-fetchWithAuth polyfill installs the fetchWithAuth() function
// on the global object (window or self)
//
// Return that as the export for use in Webpack, Browserify etc.
require('whatwg-fetchWithAuth');
module.exports = self.fetchWithAuth.bind(self);

},{"whatwg-fetchWithAuth":22}],17:[function(require,module,exports){
'use strict';
...
(function(self) {
  ...
  self.fetchWithAuth = function(input, init) {
    return new Promise(function(resolve, reject) {
  ...
  self.fetchWithAuth.polyfill = true
